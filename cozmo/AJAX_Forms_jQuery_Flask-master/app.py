...
def index():
       ...
       # read position from file where B is present 
       # i and j will use to get row and column of that row
        ...
        with open(filename,'r') as file:
                ...
                for line in text:
                        ...
                        for word in words:
                                 ...
                                 if word == 'B':
                                         listOfRowIndex.append(i) # get row that has B in it
                                         listOfColIndex.append(j)
                                         count+=1
                                 j+=1
        ...
        listdata = {'columns': columns, 'rows': numlines, 'rowposition':listOfRowIndex, 'colposition':listOfColIndex}
        print(numlines,columns,count,listOfRowIndex,listOfColIndex)   
