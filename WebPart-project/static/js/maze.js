...
function Ball(x, y, radius, dx, dy){
	...
	this.moveRight = function(){
	   ...
	   if (isInXrange(this.x))
		 {
			console.log("printss");
		  // this.draw();
		}
		else{
			document.location.href="http://127.0.0.1:5000/StageOne";
	   }
		...
		if (isInXrange(this.x))
		 {
		  ...
		  // this.draw();
			...
			document.location.href="http://127.0.0.1:5000/StageTwo";
	   }
			...
			if(this.x - radius > 0){
			 ...
			 if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageTne";
	        }
		   this.draw();
		    ...
		    if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageThree";
		   }
		   ...
		   if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageFour";
		   }
		   ...
		   if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageFive";
		   }
		   ...
		   if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageSix";
		   }
            ...
            if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageSeven";
		   }
		  this.draw();
	}
           ...
           if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageEight";
		   }
		  this.draw();
	}
            ...
            if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageNine";
		   }
		  this.draw();
	}
		   ...
		   if (isInXrange(this.x))
			 {
			  ...
			  // this.draw();
				...
				document.location.href="http://127.0.0.1:5000/StageTen";
		   }
